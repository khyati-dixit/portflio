...
const fadeLeft = {
  ...
  show: (i = 0) => ({
    opacity: 1,
    x: 0,
    transition: { duration: 0.5, delay: 0.1 + i * 0.1, ease: [0.2, 0.7, 0.2, 1] },
  }),
};

const CONTACT_INFO = [
  { icon: Mail, label: "EMAIL", value: "khyati.dixit@example.com" },
  { icon: Linkedin, label: "LINKEDIN", value: "linkedin.com/in/khyatidixit" },
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:khyati.dixit@example.com?subject=${encodeURIComponent(
      subject
      ...
      <div className="max-w-[1180px] mx-auto px-8 grid grid-cols-1 md:grid-cols-[0.85fr_1.15fr] gap-10 md:gap-14">
        <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }}>
          ...
          <p style={{ color: textMuted }} className="text-base leading-relaxed">
            Reach out for full-time roles, contract work, or just to talk frontend architecture.
          </p>
            ...
            {CONTACT_INFO.map((c, i) => (
              ...
              >
                <GlassCard className="flex items-center gap-4 px-5 py-5">
                  ...
                  >
                    <c.icon className="w-[18px] h-[18px]" style={{ color: textStrong }} />
                  </div>
                  <span className="min-w-0">
                    ...
                    <span style={{ color: textStrong }} className="block text-[15px] font-medium truncate">
                      {c.value}
                    </span>
                  </span>
                </GlassCard>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              <label htmlFor="name" style={{ color: textMuted }} className="block font-mono text-[11.5px] mb-2">
                Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="email" style={{ color: textMuted }} className="block font-mono text-[11.5px] mb-2">
                Email
              </label>
              <input
                id="email"
          ...
          <div className="mb-4">
            <label htmlFor="subject" style={{ color: textMuted }} className="block font-mono text-[11.5px] mb-2">
              Subject
            </label>
            <input
              id="subject"
          ...
          <div className="mb-4">
            <label htmlFor="message" style={{ color: textMuted }} className="block font-mono text-[11.5px] mb-2">
              Message
            </label>
            <textarea
              id="message"
          ...
          <p style={{ color: textMuted }} className="text-[12.5px] mt-3.5 leading-relaxed">
            Submitting opens your email client with this message pre-filled — nothing is sent from this page.
          </p>
        </motion.form>
      </div>
    </section>
